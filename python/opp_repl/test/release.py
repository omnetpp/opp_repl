...
def run_release_tests(simulation_project, clean=True, build=True, **kwargs):
    ...
    if clean:
        ...
        clean_project(simulation_project=simulation_project, mode="debug")
        clean_project(simulation_project=simulation_project, mode="sanitize")
    if build:
